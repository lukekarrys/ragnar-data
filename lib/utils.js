...
const deepPick = (obj, props, separator) => deepPicker(obj, props, separator, (props, key) => props.length ? props.includes(key) : true)
const deepOmit = (obj, props, separator) => deepPicker(obj, props, separator, (props, key) => props.length ? !props.includes(key) : true)
